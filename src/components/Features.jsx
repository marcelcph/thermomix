    ...
    <>
      ...
      <div className="md:max-w-xl md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 mb-8">
        ...
        <p className="   ">
          ...
          retter til de mest simple. Med vores køkkenmaskine kan du lave mad til
          hele familien, og du kan lave mad til enhver lejlighed. Uanset om du
          er til det enkle eller det avancerede, kan du lave det med en
          Thermomix.
        </p>
      </div>
        ...
        <div className="flex flex-col justify-center ">
          <div className="flex flex-wrap md:flex-nowrap">
            ...
            <div>
              ...
              <p className=" ">
                Du kan blive din families masterchef og lave lækker mad til dem
                og dermed gøre hverdagen lidt mere lækker.
              </p>
          ...
          <div className="flex flex-wrap md:flex-nowrap">
            ...
            <div>
              ...
              <p className=" ">
                Ved hjælp af et hav af funktioner, kan du lave mad på en simpel
                og effektiv måde. Opskrifterne er nemme at følge, og
      ...
      <section className="my-32 ">
        <div className="gap-8 items-center py-16 mx-4 md:mx-auto container lg:my-[2.8rem] 3xl:my-10 lg:max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 max-w-fit">
          <img
